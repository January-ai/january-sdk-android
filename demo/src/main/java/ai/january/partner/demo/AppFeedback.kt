...
fun AuthenticationRequiredCard() {
    DemoCard {
        Column(Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.spacedBy(10.dp)) {
            ...
            Text(
                "Set january.partnerTokenUrl in local.properties, then rebuild. For a hosted relay, also set january.partnerSessionToken. For the Debug-only API-key shortcut, see the README.",
