...
//         METHOD: POST              # affect only this method's requests (default all)
//         HOLD: "true"              # handle the request at once but keep its answer
//                                   # open until scripts/release-fixture.js (default false)
...
const url =
  ...
  (method ? '&method=' + method : '') + '&hold=' + hold;
