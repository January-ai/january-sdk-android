...
internal interface AuthenticationApi {
     ...
     *  - 403: `forbidden` — client tokens have been switched off for your account (turn them back on in the [Developer Dashboard](https://dashboard.january.ai)), or the key is issued for the other API version.  `client_token_not_allowed` — this request was made with a client token, and minting requires your `sk-` API key.
