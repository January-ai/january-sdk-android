...
import ai.january.partner.transport.auth.HttpBearerAuth
...
internal class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "ai.january.partner.transport.baseUrl"
        @Deprecated(
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(BASE_URL_KEY, "https://partners.january.ai")
        }
    }
}
